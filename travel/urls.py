...
urlpatterns = [
    ...
    url(r'^chateau_detail/(?P<chateau_id>\d+)+/(?P<site>\w+)$', views.chateau_detail, name='chateau_detail'),
    ...
    url(r'^make_contract/(?P<contract_id>\d+)/(?P<company_name>\w+)$',views.make_contract, name='make_contract'),
]
